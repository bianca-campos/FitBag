...
//        self.sceneView.debugOptions = [ARSCNDebugOptions.showFeaturePoints, ARSCNDebugOptions.showWorldOrigin]
    ...
    func nodeWithPosition(_ position: SCNVector3) -> SCNNode {
        ...
        // set color
        sphere.firstMaterial?.diffuse.contents = UIColor(red: 255.0/255.0, green: 228.0/255.0, blue: 0.0/255.0, alpha: 1.0)
        // set lighting model
    ...
    // callew when a node will be updated with data from the given anchor
    func renderer(_ renderer: SCNSceneRenderer, willUpdate node: SCNNode, for anchor: ARAnchor) {}
    
    // called when a node has been update with data from the given anchor
